...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_17617 = 0;while(true){
var m_17618 = cljs.core.async.impl.dispatch.tasks.pop();if((m_17618 == null))
{} else
{m_17618.call(null);
if((count_17617 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__17619 = (count_17617 + 1);
count_17617 = G__17619;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__9367__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__9367__auto__)
