...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t17623 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t17623 = (function (val,box,meta17624){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t17623.cljs$lang$type = true;
cljs.core.async.impl.channels.t17623.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t17623";
cljs.core.async.impl.channels.t17623.cljs$lang$ctorPrWriter = (function (this__9946__auto__,writer__9947__auto__,opt__9948__auto__){return cljs.core._write.call(null,writer__9947__auto__,"cljs.core.async.impl.channels/t17623");
});
cljs.core.async.impl.channels.t17623.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t17623.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17625){var self__ = this;
var _17625__$1 = this;return self__.meta17624;
});
cljs.core.async.impl.channels.t17623.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17625,meta17624__$1){var self__ = this;
var _17625__$1 = this;return (new cljs.core.async.impl.channels.t17623(self__.val,self__.box,meta17624__$1));
});
cljs.core.async.impl.channels.__GT_t17623 = (function __GT_t17623(val__$1,box__$1,meta17624){return (new cljs.core.async.impl.channels.t17623(val__$1,box__$1,meta17624));
});
}
return (new cljs.core.async.impl.channels.t17623(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__9949__auto__,writer__9950__auto__,opts__9951__auto__){return cljs.core._write.call(null,writer__9950__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__9946__auto__,writer__9947__auto__,opt__9948__auto__){return cljs.core._write.call(null,writer__9947__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_17626 = self__.takes.pop();if((taker_17626 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_17626))
{var take_cb_17627 = cljs.core.async.impl.protocols.commit.call(null,taker_17626);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_17627,taker_17626){
return (function (){return take_cb_17627.call(null,null);
});})(take_cb_17627,taker_17626))
);
} else
{}
{
...
var putter_17628 = self__.puts.pop();if(!((putter_17628 == null)))
{var put_handler_17629 = putter_17628.handler;var val_17630 = putter_17628.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_17629))
{var put_cb_17631 = cljs.core.async.impl.protocols.commit.call(null,put_handler_17629);var __17632__$1 = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_17631,__17632__$1,put_handler_17629,val_17630,putter_17628){
return (function (){return put_cb_17631.call(null,true);
});})(put_cb_17631,__17632__$1,put_handler_17629,val_17630,putter_17628))
);
cljs.core.async.impl.protocols.add_BANG_.call(null,self__.buf,val_17630);
} else
{{
continue;
}
