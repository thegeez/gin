...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__9946__auto__,writer__9947__auto__,opt__9948__auto__){return cljs.core._write.call(null,writer__9947__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_17582 = 0;while(true){
if((i_17582 < arr.length))
{(arr[i_17582] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__9946__auto__,writer__9947__auto__,opt__9948__auto__){return cljs.core._write.call(null,writer__9947__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_17589 = (self__.level + 1);while(true){
if((i_17589 <= (new_level + 1)))
{(update[i_17589] = self__.header);
{
var G__17590 = (i_17589 + 1);
i_17589 = G__17590;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_17591 = 0;while(true){
if((i_17591 <= self__.level))
{var links_17592 = (update[i_17591]).forward;if(((links_17592[i_17591]) === x__$1))
{(links_17592[i_17591] = (x__$1.forward[i_17591]));
{
var G__17593 = (i_17591 + 1);
i_17591 = G__17593;
continue;
}
} else
{{
var G__17594 = (i_17591 + 1);
i_17591 = G__17594;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__9379__auto__ = (cljs.core.truth_((function (){var and__9367__auto__ = me;if(cljs.core.truth_(and__9367__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__9367__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__9379__auto__))
