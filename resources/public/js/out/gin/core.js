...
gin.core.start_app = (function start_app(app_config){var map__14349 = app_config;var map__14349__$1 = ((cljs.core.seq_QMARK_.call(null,map__14349))?cljs.core.apply.call(null,cljs.core.hash_map,map__14349):map__14349);var app = map__14349__$1;var service = cljs.core.get.call(null,map__14349__$1,new cljs.core.Keyword(null,"service","service",2998057511));var render = cljs.core.get.call(null,map__14349__$1,new cljs.core.Keyword(null,"render","render",4374279432));var conn = cljs.core.get.call(null,map__14349__$1,new cljs.core.Keyword(null,"conn","conn",1016963742));datascript.listen_BANG_.call(null,conn,(function (report){console.log("db-after",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"db-after","db-after",1658340159).cljs$core$IFn$_invoke$arity$1(report)));
...
{return alert([cljs.core.str("Something broken with: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.filter.call(null,(function (d){return (new cljs.core.Keyword(null,"e","e",1013904343).cljs$core$IFn$_invoke$arity$1(d) == null);
}),new cljs.core.Keyword(null,"tx-data","tx-data",4365248709).cljs$core$IFn$_invoke$arity$1(report))))].join(''));
} else
{return null;
}
}));
