...
gin.lobby.core.error_handler = (function error_handler(){return gin.ui.dom_helpers.show_element.call(null,gin.ui.dom_helpers.get_element.call(null,"network-header-error"),true);
});
gin.lobby.core.goto_url = (function goto_url(url){return window.location = url;
});
...
var source = gin.event_source.event_source.call(null,"/lobby/events",new cljs.core.Keyword(null,"on-message","on-message",1496225163),(function (event){if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(event),new cljs.core.Keyword(null,"open","open",1017321916)))
