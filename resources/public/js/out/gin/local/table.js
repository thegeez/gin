...
gin.local.table.get_init_shuffle = (function get_init_shuffle(){var deck = gin.local.table.shuffle_set.call(null,cljs.core.set.call(null,(function (){var iter__10096__auto__ = (function iter__11761(s__11762){return (new cljs.core.LazySeq(null,(function (){var s__11762__$1 = s__11762;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__11762__$1);if(temp__4092__auto__)
{var xs__4579__auto__ = temp__4092__auto__;var suit = cljs.core.first.call(null,xs__4579__auto__);var iterys__10092__auto__ = ((function (s__11762__$1,suit,xs__4579__auto__,temp__4092__auto__){
return (function iter__11763(s__11764){return (new cljs.core.LazySeq(null,((function (s__11762__$1,suit,xs__4579__auto__,temp__4092__auto__){
return (function (){var s__11764__$1 = s__11764;while(true){
var temp__4092__auto____$1 = cljs.core.seq.call(null,s__11764__$1);if(temp__4092__auto____$1)
{var s__11764__$2 = temp__4092__auto____$1;if(cljs.core.chunked_seq_QMARK_.call(null,s__11764__$2))
{var c__10094__auto__ = cljs.core.chunk_first.call(null,s__11764__$2);var size__10095__auto__ = cljs.core.count.call(null,c__10094__auto__);var b__11766 = cljs.core.chunk_buffer.call(null,size__10095__auto__);if((function (){var i__11765 = 0;while(true){
if((i__11765 < size__10095__auto__))
{var rank = cljs.core._nth.call(null,c__10094__auto__,i__11765);cljs.core.chunk_append.call(null,b__11766,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"suit","suit",1017446015),suit,new cljs.core.Keyword(null,"rank","rank",1017397150),rank], null));
{
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__11766),iter__11763.call(null,cljs.core.chunk_rest.call(null,s__11764__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__11766),null);
}
} else
{var rank = cljs.core.first.call(null,s__11764__$2);return cljs.core.cons.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"suit","suit",1017446015),suit,new cljs.core.Keyword(null,"rank","rank",1017397150),rank], null),iter__11763.call(null,cljs.core.rest.call(null,s__11764__$2)));
}
} else
{return null;
}
...
});})(s__11762__$1,suit,xs__4579__auto__,temp__4092__auto__))
,null,null));
});})(s__11762__$1,suit,xs__4579__auto__,temp__4092__auto__))
...
{return cljs.core.concat.call(null,fs__10093__auto__,iter__11761.call(null,cljs.core.rest.call(null,s__11762__$1)));
} else
{{
var G__11768 = cljs.core.rest.call(null,s__11762__$1);
s__11762__$1 = G__11768;
continue;
}
}
} else
...
gin.local.table.set_our_discard = (function set_our_discard(discard){cljs.core.swap_BANG_.call(null,gin.local.table.table,(function (p1__11769_SHARP_){return cljs.core.update_in.call(null,cljs.core.update_in.call(null,p1__11769_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"our-cards","our-cards",3774215444)], null),cljs.core.disj,discard),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"discards","discards",1286668039)], null),cljs.core.conj,discard);
}));
