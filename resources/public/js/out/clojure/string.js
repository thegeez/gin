...
{var pred__20752 = cljs.core._EQ_;var expr__20753 = limit;if(cljs.core.truth_(pred__20752.call(null,1,expr__20753)))
...
{var ch = s.charAt(index);var temp__4090__auto___20759 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___20759))
{var replacement_20760 = temp__4090__auto___20759;buffer.append([cljs.core.str(replacement_20760)].join(''));
} else
{buffer.append(ch);
}
{
