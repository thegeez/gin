...
{{
var G__13285 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13285;
continue;
}
} else
...
{var pred__13289 = cljs.core._EQ_;var expr__13290 = limit;if(cljs.core.truth_(pred__13289.call(null,1,expr__13290)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13289.call(null,2,expr__13290)))
...
var G__13292 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13293 = (limit__$1 - 1);
var G__13294 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13292;
limit__$1 = G__13293;
parts = G__13294;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13296 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13296))
{var replacement_13297 = temp__4090__auto___13296;buffer.append([cljs.core.str(replacement_13297)].join(''));
} else
{buffer.append(ch);
}
{
var G__13298 = (index + 1);
index = G__13298;
continue;
}
}
