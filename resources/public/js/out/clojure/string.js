...
{{
var G__20851 = cljs.core.pop.call(null,v__$1);
v__$1 = G__20851;
continue;
}
} else
...
{var pred__20855 = cljs.core._EQ_;var expr__20856 = limit;if(cljs.core.truth_(pred__20855.call(null,1,expr__20856)))
...
var G__20858 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__20859 = (limit__$1 - 1);
var G__20860 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__20858;
limit__$1 = G__20859;
parts = G__20860;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___20862 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___20862))
{var replacement_20863 = temp__4090__auto___20862;buffer.append([cljs.core.str(replacement_20863)].join(''));
} else
{buffer.append(ch);
}
{
