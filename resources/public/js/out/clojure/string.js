...
{var pred__21042 = cljs.core._EQ_;var expr__21043 = limit;if(cljs.core.truth_(pred__21042.call(null,1,expr__21043)))
...
{var ch = s.charAt(index);var temp__4090__auto___21049 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___21049))
{var replacement_21050 = temp__4090__auto___21049;buffer.append([cljs.core.str(replacement_21050)].join(''));
} else
{buffer.append(ch);
}
{
