...
{{
var G__12856 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12856;
continue;
}
} else
...
{var pred__12860 = cljs.core._EQ_;var expr__12861 = limit;if(cljs.core.truth_(pred__12860.call(null,1,expr__12861)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__12860.call(null,2,expr__12861)))
...
var G__12863 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12864 = (limit__$1 - 1);
var G__12865 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12863;
limit__$1 = G__12864;
parts = G__12865;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___12867 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___12867))
{var replacement_12868 = temp__4090__auto___12867;buffer.append([cljs.core.str(replacement_12868)].join(''));
} else
{buffer.append(ch);
}
{
